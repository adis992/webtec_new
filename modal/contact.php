...
$php_main_email = "webtec@web-tec.ba";
...
if (filter_var($php_email, FILTER_VALIDATE_EMAIL)) {
		...
		$php_subject = "Poruka sa kontakt forme";
		...
		. 'Hvala sto ste nas kontaktirali!.<br/><br/>'
		. '<strong style="color:#f00a77;">Ime:</strong>  ' . $php_name . '<br/>'
		. '<strong style="color:#f00a77;">Email:</strong>  ' . $php_email . '<br/>'
		. '<strong style="color:#f00a77;">Sadrzaj poruke:</strong>  ' . $php_message . '<br/><br/>'
		. 'Ovo je email za potvrdu kontakta.'
		. '<br/>'
		. 'Mi ćemo Vas kontaktirati u najkraćem mogućem roku .</div>';
	...
	echo "<span class='contact_error'>* Pogresan email *</span>";
}
